...
('Ana', 'Pérez García', '3ro', 'A', 'Activo', NOW(), NOW()),
('Luis', 'González López', '2do', 'B', 'Activo', NOW(), NOW()),
('Sofía', 'Martínez Rodríguez', '1ro', 'C', 'Activo', NOW(), NOW()),
('Carlos', 'Sánchez Vargas', '3ro', 'B', 'Activo', NOW(), NOW()),
('Valentina', 'Ramírez Castro', '2do', 'A', 'Activo', NOW(), NOW()),
('Mateo', 'Flores Díaz', '1ro', 'A', 'Activo', NOW(), NOW()),
('Isabella', 'Ruiz Jiménez', '3ro', 'C', 'Activo', NOW(), NOW()),
('Sebastián', 'Torres Morales', '2do', 'C', 'Activo', NOW(), NOW()),
('Camila', 'Vargas Núñez', '1ro', 'B', 'Activo', NOW(), NOW()),
('Daniel', 'Hernández Soto', '3ro', 'A', 'Activo', NOW(), NOW()),
('Emilia', 'Díaz Chávez', '2do', 'B', 'Activo', NOW(), NOW()),
('Javier', 'Rojas Flores', '1ro', 'C', 'Activo', NOW(), NOW()),
('Renata', 'Jiménez Castillo', '3ro', 'B', 'Activo', NOW(), NOW()),
('Andrés', 'Morales Ruiz', '2do', 'A', 'Activo', NOW(), NOW()),
('Victoria', 'Soto Vargas', '1ro', 'A', 'Activo', NOW(), NOW()),
('Diego', 'Castro Hernández', '3ro', 'C', 'Activo', NOW(), NOW()),
('Paula', 'Núñez Díaz', '2do', 'C', 'Activo', NOW(), NOW()),
('Gabriel', 'Chávez Rojas', '1ro', 'B', 'Activo', NOW(), NOW()),
('Fernanda', 'Castillo Jiménez', '3ro', 'A', 'Activo', NOW(), NOW()),
('Joaquín', 'Ruiz Morales', '2do', 'B', 'Activo', NOW(), NOW()),
('Mariana', 'Vargas Soto', '1ro', 'C', 'Activo', NOW(), NOW()),
('Santiago', 'Hernández Castro', '3ro', 'B', 'Activo', NOW(), NOW()),
('Valeria', 'Díaz Núñez', '2do', 'A', 'Activo', NOW(), NOW()),
('Nicolás', 'Rojas Chávez', '1ro', 'A', 'Activo', NOW(), NOW()),
('Ximena', 'Jiménez Flores', '3ro', 'C', 'Activo', NOW(), NOW()),
('Adrián', 'Morales Castillo', '2do', 'C', 'Activo', NOW(), NOW()),
('Lucía', 'Soto Ruiz', '1ro', 'B', 'Activo', NOW(), NOW()),
('Mateo', 'Castro Vargas', '3ro', 'A', 'Activo', NOW(), NOW()),
('Regina', 'Núñez Hernández', '2do', 'B', 'Activo', NOW(), NOW()),
('Emilio', 'Chávez Díaz', '1ro', 'C', 'Activo', NOW(), NOW()),
('Isabela', 'Castillo Rojas', '3ro', 'B', 'Activo', NOW(), NOW()),
('Leonardo', 'Ruiz Jiménez', '2do', 'A', 'Activo', NOW(), NOW()),
('Monserrat', 'Vargas Morales', '1ro', 'A', 'Activo', NOW(), NOW()),
('Alejandro', 'Hernández Soto', '3ro', 'C', 'Activo', NOW(), NOW()),
('Camila', 'Díaz Castro', '2do', 'C', 'Activo', NOW(), NOW()),
('Sebastián', 'Rojas Núñez', '1ro', 'B', 'Activo', NOW(), NOW()),
('Natalia', 'Jiménez Chávez', '3ro', 'A', 'Activo', NOW(), NOW()),
('Andrés', 'Morales Flores', '2do', 'B', 'Activo', NOW(), NOW()),
('Sofía', 'Soto Castillo', '1ro', 'C', 'Activo', NOW(), NOW()),
('Carlos', 'Castro Ruiz', '3ro', 'B', 'Activo', NOW(), NOW()),
('Valentina', 'Núñez Vargas', '2do', 'A', 'Activo', NOW(), NOW()),
('Mateo', 'Chávez Hernández', '1ro', 'A', 'Activo', NOW(), NOW()),
('Isabella', 'Castillo Díaz', '3ro', 'C', 'Activo', NOW(), NOW()),
('Sebastián', 'Ruiz Rojas', '2do', 'C', 'Activo', NOW(), NOW()),
('Camila', 'Vargas Jiménez', '1ro', 'B', 'Activo', NOW(), NOW()),
('Daniel', 'Hernández Morales', '3ro', 'A', 'Activo', NOW(), NOW()),
('Emilia', 'Díaz Soto', '2do', 'B', 'Activo', NOW(), NOW()),
('Javier', 'Rojas Castro', '1ro', 'C', 'Activo', NOW(), NOW()),
('Renata', 'Jiménez Núñez', '3ro', 'B', 'Activo', NOW(), NOW());
